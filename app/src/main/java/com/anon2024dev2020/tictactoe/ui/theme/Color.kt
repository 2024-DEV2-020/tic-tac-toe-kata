...
object TicTacToeColors {
    // Player 1 Colors (Primary-based)
    object Player1 {
        val main = primaryLight
        val container = primaryContainerLight
        val onContainer = onPrimaryContainerLight
        val accent = errorLight

        // Dark theme variants
        val mainDark = primaryDark
        val containerDark = primaryContainerDark
        val onContainerDark = onPrimaryContainerDark
        val accentDark = errorDark
    }

    // Player 2 Colors (Secondary-based)
    object Player2 {
        val main = secondaryLight
        val container = secondaryContainerLight
        val onContainer = onSecondaryContainerLight
        val accent = tertiaryLight

        // Dark theme variants
        val mainDark = secondaryDark
        val containerDark = secondaryContainerDark
